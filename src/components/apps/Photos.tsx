...
export interface Photo {
  ...
  liked?: boolean;
  recent?: boolean;
  album: "me" | "udaipur" | "people";
}

const PHOTOS: Photo[] = [
  // My Photos (Desktop/Neww)
  { id: "me-1", url: "/photos/me/me_01.jpg", label: "Portrait Shot", date: "Apr 11, 2026", liked: true, recent: true, album: "me" },
  { id: "me-2", url: "/photos/me/me_02.jpg", label: "Casual Day", date: "Mar 9, 2024", album: "me" },
  { id: "me-3", url: "/photos/me/me_03.jpg", label: "Campus Walk", date: "Apr 13, 2024", album: "me" },
  { id: "me-4", url: "/photos/me/me_04.jpg", label: "Evening Vibe", date: "Sep 9, 2024", liked: true, recent: true, album: "me" },
  { id: "me-5", url: "/photos/me/me_05.jpg", label: "Summer Days", date: "Aug 10, 2025", album: "me" },
  { id: "me-6", url: "/photos/me/me_06.jpg", label: "Winter Mood", date: "Dec 5, 2025", album: "me" },
  { id: "me-7", url: "/photos/me/me_07.jpg", label: "Golden Hour", date: "Dec 6, 2025", liked: true, recent: true, album: "me" },
  { id: "me-8", url: "/photos/me/me_08.jpg", label: "Night Aesthetic", date: "Sep 13, 2026", recent: true, album: "me" },

  // Udaipur (Desktop/Udaipur)
  { id: "ud-1", url: "/photos/udaipur/udaipur_01.jpg", label: "Fateh Sagar Lake", date: "Aug 15, 2026", liked: true, recent: true, album: "udaipur" },
  { id: "ud-2", url: "/photos/udaipur/udaipur_02.jpg", label: "City Palace & Ghats", date: "Aug 15, 2026", liked: true, recent: true, album: "udaipur" },
  { id: "ud-3", url: "/photos/udaipur/udaipur_03.jpg", label: "Udaipur Scenic View", date: "Aug 17, 2026", album: "udaipur" },

  // People (Desktop/People)
  { id: "pe-1", url: "/photos/people/people_01.jpg", label: "Gathering & Hangout", date: "Dec 20, 2024", liked: true, recent: true, album: "people" },
  { id: "pe-2", url: "/photos/people/people_02.jpg", label: "Campus Friends", date: "Sep 23, 2025", album: "people" },
  { id: "pe-3", url: "/photos/people/people_03.jpg", label: "Team Meetup", date: "Oct 8, 2025", album: "people" },
  { id: "pe-4", url: "/photos/people/people_04.jpg", label: "Celebration Night", date: "Nov 15, 2025", liked: true, recent: true, album: "people" },
];

const ALBUMS = [
  { id: "recents", label: "Recents", icon: "i-ph:clock" },
  { id: "favorites", label: "Favourites", icon: "i-ph:heart-fill" },
  { id: "me", label: "My Photos", icon: "i-ph:user" },
  { id: "udaipur", label: "Udaipur", icon: "i-ph:mountains" },
  { id: "people", label: "People", icon: "i-ph:users" },
];
...
export default function Photos() {
  ...
  const photos = PHOTOS.map((p) => ({
    ...p,
    liked: likedMap[p.id] ?? p.liked ?? false,
  }));

  const recentPhotos = photos.filter((p) => p.recent);

  const displayed =
    activeAlbum === "favorites"
      ? photos.filter((p) => p.liked)
      : activeAlbum === "recents"
      ? (recentPhotos.length > 0 ? recentPhotos : photos.slice(0, 8))
      : photos.filter((p) => p.album === activeAlbum);

  const getAlbumCount = (albumId: string) => {
    if (albumId === "recents") return recentPhotos.length > 0 ? recentPhotos.length : 8;
    if (albumId === "favorites") return photos.filter((p) => p.liked).length;
    ...
    >
      ...
      <div className="mobile-only mobile-tab-bar">
        ...
        <div 
          ...
          onClick={() => { if (window.innerWidth <= 768) setActiveAlbum("me"); }}
        >
          <span className="i-ph:user mobile-tab-icon" style={{ width: "24px", height: "24px" }} />
          <span>My Photos</span>
        </div>
        <div 
          className="mobile-tab-item"
