...
const PLACES = [
  { id: "1", name: "Fateh Sagar Lake", type: "Lake", lat: 24.601, lng: 73.673, color: "#007AFF" },
  { id: "2", name: "City Palace", type: "Palace", lat: 24.576, lng: 73.683, color: "#FF9500" },
  { id: "3", name: "Lake Pichola", type: "Landmark", lat: 24.574, lng: 73.678, color: "#FF3B30" },
  { id: "4", name: "Saheliyon-ki-Bari", type: "Garden", lat: 24.606, lng: 73.687, color: "#34C759" },
];
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: "11px", color: "rgba(0,0,0,0.5)" }}>
              {activePlace.type} · Udaipur, Rajasthan
            </div>
          </div>
          <button
            style={{
