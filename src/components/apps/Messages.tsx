...
const CONVERSATIONS: Conversation[] = [
  ...
  },
  {
    ...
    time: "2m",
    messages: [
      { id: "1", text: "Hey Yuvraj, the new backend endpoints look super clean!", from: "them", time: "9:00 AM" },
      { id: "2", text: "Thanks! Optimized database queries and response times.", from: "me", time: "9:05 AM" },
  ...
  },
  {
    ...
    time: "3h",
    messages: [
      { id: "1", text: "⭐ yuvrajsen-cloud/macOS-Portfolio received a new star!", from: "them", time: "7:00 AM" },
