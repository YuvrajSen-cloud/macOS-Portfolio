...
const FILESYSTEM: Record<string, FileItem[]> = {
  home: [
    ...
    },
    {
      ...
      color: "#F5A623",
      children: [
        { id: "resume", name: "Yuvraj_Sen_Resume.pdf", kind: "file", ext: "pdf", size: "340 KB", date: "Jun 1", icon: "/img/icons/sf-icons/doc.svg" },
    ...
    },
    {
      ...
      color: "#FF6B6B",
      children: [
        { id: "avatar", name: "avatar.jpg", kind: "file", ext: "jpg", size: "268 KB", date: "Recent", icon: "/img/icons/sf-icons/image.svg" },
        { id: "me-folder", name: "My Photos", kind: "folder", date: "Today", icon: "/img/icons/sf-icons/folder.svg", color: "#FF6B6B" },
        { id: "udaipur-folder", name: "Udaipur", kind: "folder", date: "Recent", icon: "/img/icons/sf-icons/folder.svg", color: "#FF6B6B" },
        { id: "people-folder", name: "People", kind: "folder", date: "Recent", icon: "/img/icons/sf-icons/folder.svg", color: "#FF6B6B" },
      ],
    },
    {
      id: "music",
      ...
      color: "#FF2D55",
      children: [
        { id: "dreamer", name: "dreamer.mp3", kind: "file", ext: "mp3", size: "4.2 MB", date: "Today", icon: "/img/icons/sf-icons/sound.svg" },
        { id: "dancin", name: "dancin.mp3", kind: "file", ext: "mp3", size: "3.2 MB", date: "Today", icon: "/img/icons/sf-icons/sound.svg" },
        { id: "loser", name: "loser.mp3", kind: "file", ext: "mp3", size: "3.8 MB", date: "Today", icon: "/img/icons/sf-icons/sound.svg" },
        { id: "earrings", name: "earrings.mp3", kind: "file", ext: "mp3", size: "2.9 MB", date: "Today", icon: "/img/icons/sf-icons/sound.svg" },
        { id: "freaks", name: "freaks.mp3", kind: "file", ext: "mp3", size: "2.5 MB", date: "Today", icon: "/img/icons/sf-icons/sound.svg" },
      ],
    },
    {
      id: "repos",
...
export default function Finder() {
  ...
  const locationLabel = () => {
    if (location === "home") return "Yuvraj";
