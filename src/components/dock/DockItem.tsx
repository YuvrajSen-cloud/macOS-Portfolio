      ...
      {(() => {
        ...
        const content = isPortfolio ? (
          <motion.div
            ...
            style={
              winWidth < 640
                ? { width: dockSize, height: dockSize, borderRadius: "22.5%", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: '#fff', boxShadow: "inset 0 0 0 1px rgba(0,0,0,0.1), 0 4px 6px rgba(0,0,0,0.2)", overflow: 'hidden' }
                : { width, height: width, borderRadius: "22.5%", display: "flex", alignItems: "center", justifyContent: "center", willChange: "width, height", backgroundColor: '#fff', boxShadow: "inset 0 0 0 1px rgba(0,0,0,0.1), 0 4px 6px rgba(0,0,0,0.2)", overflow: 'hidden' }
            }
          >
            <img
              src={img}
