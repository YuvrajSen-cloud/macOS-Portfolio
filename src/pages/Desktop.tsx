...
export default function Desktop(props: MacActions) {
  ...
  useEffect(() => {
    ...
    const handleLaunchpadOpenApp = (e: any) => {
      toggleLaunchpad(false);
      openApp(e.detail);
    };

    window.addEventListener("launchpad:openSafari", handleOpenSafari);
    window.addEventListener("launchpad:openApp", handleLaunchpadOpenApp);
    ...
    return () => {
      ...
      window.removeEventListener("launchpad:openApp", handleLaunchpadOpenApp);
